...
export default function DashboardLayout({
  ...
  return (
    <>
      ...
      <div className="flex overflow-hidden bg-white pt-16 dark:bg-slate-900 dark:border-slate-700 dark:text-white ">
        <aside
          id="sidebar"
          ...
          <div className="relative flex-1 flex flex-col min-h-0 borderR border-gray-200 bg-white pt-0 dark:bg-slate-900 dark:border-slate-700">
            <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
              <div className="flex-1 px-3 bg-white divide-y space-y-1 dark:bg-slate-900 dark:border-slate-700">
                <ul className="space-y-2 pb-2">
                  {links.map((link) => (
                    <li key={link.href}>
                      <Link
                        href={link.href}
                        className="text-base capitalize text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group dark:bg-slate-900 dark:hover:bg-slate-800 dark:text-slate-300 dark:border-slate-700">
          ...
          <main>
            <div className="pt-6 px-4">
              <div className="w-full min-h-[calc(100vh-230px)]">
                <div className="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 dark:bg-slate-900 dark:border-slate-700">
                  {children}
                </div>
              </div>
            </div>
          </main>
          <footer className="bg-white md:flex md:items-center md:justify-between shadow rounded-lg p-4 md:p-6 xl:p-8 my-6 mx-4 print:hidden dark:bg-slate-900 dark:border-slate-700">
